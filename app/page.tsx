...
const heroImages = ["/Vagabondo1.jpg", "/Neha1.jpg", "/Lebih1.jpg", "/Vagabondo2.jpg", "/Neha2.jpg", "/Neha3.jpg", "/Vagabondo1.jpg", "/Neha1.jpg", "/Lebih1.jpg", "/Vagabondo2.jpg"];
...
const portfolioImages = [
  {
    ...
    caption: "Editorial Portrait Series",
    category: "Portrait",
  },
  {
    id: 2,
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/95 flex items-center justify-center">
      ...
      <div className="max-w-7xl max-h-[90vh] relative">
        <Image src={currentImage.src || "/placeholder.svg"} alt={currentImage.alt} width={1200} height={800} className="max-w-full max-h-full object-contain" priority />
...
export default function PhotographyPortfolio() {
  ...
  useEffect(() => {
    ...
    setCurrentSlide(currentMinute % 10);
        ...
        <div className="absolute inset-0">
          {heroImages.map((image, index) => (
            <div
              ...
              <Image src={image || "/placeholder.svg"} alt={`Hero slide ${index + 1}`} fill className="object-cover" priority={index === 0} sizes="100vw" />
            </div>
          ))}
        </div>
